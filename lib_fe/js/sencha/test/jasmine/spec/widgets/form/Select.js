describe("Ext.form.Select", function() {
    ...
    afterEach(function() {
        if (select && select.listPanel) select.listPanel.destroy();
        if (select && select.picker) select.picker.destroy();
    ...
    it("should have no prependText", function() {
        expect(proto.prependText).toEqual('');
    });
        ...
        describe("when rendered", function() {
            ...
            describe("fieldEl", function() {
                ...
                describe("prependText", function() {
                    it("should add prependText", function() {
                        select.prependText = ">";
