...
describe("Ext.Picker", function() {
    ...
    it("should have doneText", function() {
        expect(proto.doneText).toEqual('Done');
    });
    ...
    it("should showDoneButton", function() {
        expect(proto.showDoneButton).toBeTruthy();
    });
    
    describe("on onDoneTap", function() {
