...
describe("Ext.TabPanel", function() {
    ...
    describe("when tb.setCardLayout", function() {
        it("should add listeners", function() {
            ...
            tb.setCardLayout(newCard.layout);
            
            newCard.destroy();
        });
    });
    
    describe("when tb.getCardLayout", function() {
        it("should return the layout", function() {
            var tb = tp.getTabBar();
            
            expect(tb.getCardLayout()).toBeDefined();
        });
    });
    
    describe("when tb.onCardRemove", function() {
