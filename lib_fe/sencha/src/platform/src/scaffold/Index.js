...
Ext.scaffold.Index = Ext.extend(Ext.DataView, {
    ...
    buildItemSelectorClass: function() {
        return Ext.util.Format.format("x-scaffold-{0}", this.model.modelName);
    },
    ...
    buildToolbar: function() {
        ...
        if (this.hasNewButton) {
            items.push({
                text   : Ext.util.Format.format(this.newButtonFormat, modelName),
                scope  : this,
        ...
        if (this.hasEditButton) {
            items.push({
                text   : Ext.util.Format.format(this.editButtonFormat, modelName),
                scope  : this,
